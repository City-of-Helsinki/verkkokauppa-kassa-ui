...
export class AuthService {
  ...
  constructor() {
    ...
    this.authServerType =
      (process.env.REACT_APP_AUTH_SERVER_TYPE as "KEYCLOAK" | "TUNNISTAMO") ||
      "TUNNISTAMO";
    ...
    this.apiTokensClientConfig = {
      ...
      queryProps: this.getApiClientQueryProps(),
    };
    ...
    this.userSessionValidityPoller = createHttpPoller({
      ...
      onError: (returnedHttpStatus) => {
        ...
        if (
          ...
          returnedHttpStatus &&
          (returnedHttpStatus === StatusCodes.FORBIDDEN ||
            returnedHttpStatus === StatusCodes.UNAUTHORIZED)
        ) {
          this.logout();
